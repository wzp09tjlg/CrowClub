...
import com.sina.crowclub.view.widget.SwipeMenuRecyclerView.ResCompat;
...
public class ListViewDecoration extends RecyclerView.ItemDecoration {
    ...
    public ListViewDecoration() {
        mDrawable = ResCompat.getDrawable(MApplication.mContext, R.drawable.drawable_recycler_divider);
    }
