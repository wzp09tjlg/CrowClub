...
public class SwipeMenuAdapter implements WrapperListAdapter, SwipeMenuView.OnSwipeItemClickListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null || !(convertView instanceof SwipeMenuLayout)) {
            ...
            createMenu(menu,mAdapter.getItem(position));
            ...
            layout.closeMenu();
            layout.setPosition(position);
            layout.removeAllViews(); //清除之前的所有子view,处理防止重复创建子view,耗费内存
            ...
            SwipeMenuView menuView = new SwipeMenuView(menu,
                    (SwipeMenuListView) parent);
            menuView.setOnSwipeItemClickListener(this);
            menuView.setLayoutParams(new FrameLayout.LayoutParams(FrameLayout.LayoutParams.WRAP_CONTENT,
    ...
    public void createMenu(SwipeMenu menu,Object obj) {
        // Test Code
