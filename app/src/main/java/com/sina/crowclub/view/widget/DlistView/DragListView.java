package com.sina.crowclub.view.widget.DlistView;
...
public class DragListView extends ListView {
    ...
    private void startDragging(Bitmap bitm, int x, int y){
        ...
        //mLayoutParams.x = x - mDragPointX + mDragOffsetX;TODO WUZP
...
//        imageView.setBackgroundResource(R.drawable.icon_album_drag);
