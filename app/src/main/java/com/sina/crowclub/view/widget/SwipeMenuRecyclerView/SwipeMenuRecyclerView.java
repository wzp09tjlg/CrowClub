 ...
 */
package com.sina.crowclub.view.widget.SwipeMenuRecyclerView;
...
import com.sina.crowclub.view.widget.SwipeMenuRecyclerView.touch.DefaultItemTouchHelper;
import com.sina.crowclub.view.widget.SwipeMenuRecyclerView.touch.OnItemMoveListener;
import com.sina.crowclub.view.widget.SwipeMenuRecyclerView.touch.OnItemMovementListener;
...
public class SwipeMenuRecyclerView extends RecyclerView {
            ...
            switch (action) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    isIntercepted = false;
                     ...
                     touchingPosition = getChildAdapterPosition(findChildViewUnder(x, y));
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                break;
            case MotionEvent.ACTION_UP:
                int touchingPosition = getChildAdapterPosition(findChildViewUnder(mDownX, mDownY));
                int upPosition =  getChildAdapterPosition(findChildViewUnder(e.getX(), e.getY()));
                if(mOnItemDragCompelete != null){
                    mOnItemDragCompelete.onItemDragCompelete(touchingPosition,upPosition);
                }
                break;
            case MotionEvent.ACTION_CANCEL:
                break;
    ...
    private OnItemDragCompelete mOnItemDragCompelete;

    public void setmOnItemDragCompelete(OnItemDragCompelete mOnItemDragCompelete) {
        this.mOnItemDragCompelete = mOnItemDragCompelete;
    }

    public interface OnItemDragCompelete{
        void onItemDragCompelete(int start, int stop);
    }
}
