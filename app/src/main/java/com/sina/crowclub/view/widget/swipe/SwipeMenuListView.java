...
public class SwipeMenuListView extends ListView {
    ...
    private boolean mControlMenu = false; //控制动态显示左侧滑的菜单
    ...
    public void setControlMenu(boolean mControlMenu) {
        this.mControlMenu = mControlMenu;
    }
}
